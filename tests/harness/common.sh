...
sandbox() {
  ...
  unset QL_DRY_RUN WOOW_CF_IMAGE MOCK_SCENARIO MOCK_BAD_IMAGE MOCK_PERSIST MOCK_LEGACY_VOL \
    MOCK_EXTRA_ING MOCK_BUSY_PORTS MOCK_FAIL_START MOCK_NO_METRICS LEGACY_UNIT \
    LEGACY_GUI_PORT GUI_PORT EXTRA_UNITS HTTP_OVERRIDES RESCUE_CONTAINER EXPECT_CONNS
